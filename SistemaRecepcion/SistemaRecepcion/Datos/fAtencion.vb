...
Public Class fAtencion
    ...
    Public Function mostrar_por_numero(ByVal id_atencion As Integer) As DataTable 'Se usa DataTable ya que es el formato devuelto por SQL
        Try
            conectado() 'Llama a la funcion conectado de la clase Conexion
            cmd = New SqlCommand("mostrar_atencion_por_numero") 'Llama al procedimiento almacenado en la BD.
            cmd.CommandType = CommandType.StoredProcedure 'Selecciona el tipo de comando a enviar (Procedimiento Almacenado)
    ...
    Public Function editar_TODO(ByVal dts As vAtencion) As Boolean
        Try
            conectado()
            cmd = New SqlCommand("modificar_atencion")
            cmd.CommandType = CommandType.StoredProcedure
            cmd.Connection = cnn
            ...
            cmd.Parameters.AddWithValue("@fecha_atencion", dts.gfecha)
            cmd.Parameters.AddWithValue("@medico_remitente", dts.gdoctor_remitente)
            cmd.Parameters.AddWithValue("@id_medico_destinatario", dts.gid_medico)
