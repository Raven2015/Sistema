...
Public Class fArqueoIngreso
    ...
    Public Function mostrar_ingresos_fecha(ByVal fecha_atencion As Date, ByVal entidad As String) As DataTable 'Se usa DataTable ya que es el formato devuelto por SQL
        Try
            conectado() 'Llama a la funcion conectado de la clase Conexion
            cmd = New SqlCommand("ingresos_diarios_por_categoria") 'Llama al procedimiento almacenado en la BD.
