Public Class frmListaFlotante
    ...
    Private Sub enviar_datos()
        frmCentral.tbNombres.Text = dgvListado.SelectedCells.Item(1).Value
        frmCentral.tbApellidos.Text = dgvListado.SelectedCells.Item(2).Value
        frmCentral.tbci.Text = dgvListado.SelectedCells.Item(3).Value
        frmCentral.dtpFechaNacimiento.Text = dgvListado.SelectedCells.Item(4).Value
        frmCentral.tbCodigoAsegurado.Text = dgvListado.SelectedCells.Item(9).Value
        frmCentral.tbEdad.Text = dgvListado.SelectedCells.Item(13).Value
        frmCentral.cbSexo.Text = dgvListado.SelectedCells.Item(8).Value
        frmCentral.tbTelefono.Text = dgvListado.SelectedCells.Item(6).Value
        frmCentral.tbCelular.Text = dgvListado.SelectedCells.Item(7).Value
        frmCentral.cbxInstitucion.Text = dgvListado.SelectedCells.Item(10).Value
        frmCentral.tbRazonSocial.Text = dgvListado.SelectedCells.Item(11).Value
        frmCentral.tbNIT.Text = dgvListado.SelectedCells.Item(12).Value
    End Sub
