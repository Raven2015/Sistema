...
Public Class dlgEditarEstudio

    Private Sub dlgEditarEstudio_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If Me.ValidateChildren = True And tbIDCategoria.Text <> "" And tbNombres.Text <> "" And tbCodigoEstudio.Text <> "" Then
            Try
                ...
                If func.editar(dts) Then
                    ...
                    Me.Close()
                Else
                    MessageBox.Show("El estudio no pudo ser modificado. Intente de nuevo por favor", "Modificando Registros", MessageBoxButtons.OK, MessageBoxIcon.Error)
                End If
    ...
    Private Sub btnSeleccionarCategoria_Click(sender As Object, e As EventArgs) Handles btnSeleccionarCategoria.Click
        dlgSeleccionarCategoria.tbIndicador.Text = "1"
